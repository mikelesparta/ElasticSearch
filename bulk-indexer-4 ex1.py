...
def main():
        ...
        "settings": {
            "analysis": {
                "filter": {
                    ...
                    "synonym": {
                        "type": "synonym",
                        "lenient": "true", # to ignore exceptions
                        "synonyms": [ "michael, jackson, king, pop, king of pop => michael jackson",
                            "heart, attack, fatal => cardiac arrest",
                            "die, died, dead, rip => death" ]
                    }
                },
                "analyzer": {
                    "analizador_personalizado": {
                        "tokenizer":"standard",
                        "filter":["lowercase","replace_useless", "palabras_vacias_ingles_porter","estematizacion_ingles","uni_bi_tri_gramas","synonym"]
                    }
                }
            }
        },
    ...
    es.indices.create(index="tweets-20090624-20090626-en_es-10percent-v4.2",ignore=400,body=argumentos)
...
def procesarLineas(lineas):
  ...
  for linea in lineas:
    ...
    if datos["lang"]=="en":
        datos["_index"] = "tweets-20090624-20090626-en_es-10percent-v4.2"
        datos["_id"] = ident
